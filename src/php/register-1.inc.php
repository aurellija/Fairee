...
if (isset($_POST['reg1'])){
    ...
    $rez = "INSERT INTO registracija_1(Vartotojo_nr, Vartotojo_vardas, Keliones_nr, Vegetaras, Palapines, Lazdu_poros)
    VALUES($vart_nr,'$vart_vardas',$regnr,$veg,$palap,$lazd);";
